...
?>
	...
	<form method="post" class="edit_form" action="/admin/json" autocomplete="off">
		...
		<div class="clearfix form-group mt-5"><?php echo ($module_input_placeholder?$module_input_placeholder:'Select '.$module_input_slug_lang); ?><br><div class="float-left multi_drop w-50"><table class="bg-light table multi_drop_filled" id="multi_drop_filled_table_<?php echo $module_input_slug_lang; ?>"><tbody></tbody></table></div><div class="float-left multi_drop w-50 pl-2"><table class="table packery-table"><thead><th>Options</th></thead><tbody>
			<?php 
			if ($options=$module_input_options) {
				$i=0;
				foreach ($options as $opt) {
