...
function new_and_list ($type) {
	...
	return '
	<div class="btn-group">
		<a href="/admin/edit?type='.$type.'" class="btn btn-outline-primary border-top-0 border-left-0 border-right-0 rounded-0 btn-lg"><span class="fa fa-edit"></span>&nbsp;New</a>
		<a href="/admin/list?type='.$type.'" class="btn btn-outline-primary border-top-0 border-left-0 border-right-0 rounded-0 btn-lg"><span class="fa fa-list"></span>&nbsp;List</a>
	</div>';
}

function list_types($type='') {
	global $types;
	$list_types='<div class="btn-group" role="group"><a href="/admin/" class="btn btn-outline-primary border-top-0 border-left-0 border-right-0 rounded-0 btn-lg"><span class="fa fa-tachometer-alt"></span></a><button id="types-admin-dropdown" type="button" class="btn btn-outline-primary border-top-0 border-left-0 border-right-0 rounded-0 btn-lg dropdown-toggle px-1" data-toggle="dropdown">'.(isset($type)?ucfirst($types[$type]['plural']):'').'&nbsp;<span class="sr-only">Content types</span></button><div class="dropdown-menu" aria-labelledby="types-admin-dropdown">';
