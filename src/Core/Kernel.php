...
{
    // properties
    protected $error404_file = UI_PATH.'/errors/404.php';
    ...
    public function __construct()
    {
        ...
        self::$types = $dash->get_types(ROOT_DIR.'/config/types.json');
        self::$menus = json_decode(file_get_contents(ROOT_DIR.'/config/menus.json'), true);
    ...
    public function init()
    {
         ...
         */
        $theme_functions = UI_PATH.'/functions.php';
    ...
    {
        $file_path = UI_PATH.'/assets/sass.php';
    ...
    private function loadSearch()
    {
        ...
        $search_file = UI_PATH.'/search.php';
    ...
    private function loadAuth()
    {
        ...
        if (!$slug) {
            $auth_file = ROOT_DIR.'/vendor/wildfire/auth/init.php';

            if (!file_exists($auth_file)) {
                die('"wildfire\auth" is missing');
            }
        } else {
            $auth_file = ROOT_DIR.'/vendor/wildfire/auth/'.$slug.'.php';
    ...
    private function loadTypeSlugFile()
    {
        ...
        $file_path = UI_PATH.'/pages/'.$type.'/'.$slug.'.php';
        ...
        $file_path = UI_PATH.'/'.$type.'-'.$slug.'.php';
        ...
        $file_path = UI_PATH.'/single-'.$postdata['id'].'.php';
        ...
        $file_path = UI_PATH.'/single-'.$type.'.php';
    ...
    private function loadTypeFile()
    {
        ...
        $file_path = UI_PATH.'/templates/'.$type.'.php';
        ...
        $file_path = UI_PATH.'/archive-'.$type.'.php';
    ...
    private function loadIndex()
    {
        ...
        $file_path = UI_PATH.'/pages/index.php';
        if (file_exists($file_path)) {
            include_once $file_path;
            return true;
        }
